$(document).ready(function () {
    ...
    btnConnetti.on("click", function () { //la riga on fa semplicemente un associazione, se l'oggetto è undefined va in errore

        serverSocket = io({
            transports: ["websocket"],
            upgrade: false,
        }).connect(); //così non perdo mai la connessione
